package com.lynnpadc.moviebookingapp.network

import com.lynnpadc.moviebookingapp.data.vos.movie.checkout.CheckoutBody
import com.lynnpadc.moviebookingapp.network.responses.*
import com.lynnpadc.moviebookingapp.network.responses.cinema.CinemaInfoResponse
import com.lynnpadc.moviebookingapp.network.responses.login.CitiesResponse
import com.lynnpadc.moviebookingapp.network.responses.login.OtpResponse
import com.lynnpadc.moviebookingapp.network.responses.movie.*
import com.lynnpadc.moviebookingapp.network.responses.movie.cinema.CinemaConfigResponse
import com.lynnpadc.moviebookingapp.network.responses.movie.cinema.CinemaTimeslotResponse
import com.lynnpadc.moviebookingapp.network.responses.movie.snack.SnackCategoryResponse
import com.lynnpadc.moviebookingapp.network.responses.movie.snack.SnackListResponse
import com.lynnpadc.moviebookingapp.network.responses.profile.LogoutResponse
import com.lynnpadc.moviebookingapp.network.utiles.*
